...
- Photogrammetry software used (Pix4D / Metashape / OpenDroneMap / other)?
- CRS of the delivered products?
- Exact count of dGNSS control points and measured trees?
- Web map hosting: GitHub Pages or self-hosted?
